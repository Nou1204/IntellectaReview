# Presentation Specification, Exact Speech, and Jury Q&A

## Slide 1/13: AI-Assisted Research Paper Submission and Review Platform
Objective: Introduce the project and position it as an academic review workflow solution.
...
Visual suggestion: Cover layout with a left thesis block and a right end-to-end workflow ribbon.

Transition: I will now give the structure of the presentation so the jury can follow the progression.

Estimated oral duration: 35 seconds
...
Objective: Announce a simple six-section plan.
...
Visual suggestion: Six-step horizontal roadmap with the current section highlighted.

Transition: I will start with the context that motivated this project.

Estimated oral duration: 30 seconds
...
Objective: Show the business context before the technical solution.
...
Visual suggestion: Before-state flow: Email inbox, spreadsheet, manual reviewer choice, unclear status.

Transition: From this context, the project problem becomes clear.

Estimated oral duration: 45 seconds
...
Objective: Define the exact problem to solve.
...
Visual suggestion: Problem stack with four linked bottlenecks from submission to final decision.
...
Objective: Present the value proposition and full target chain.
...
Visual suggestion: Main chain: upload -> GROBID -> correction -> submission -> embedding -> assignment -> review tools -> decision.

Transition: Before discussing the implementation, I will summarize the expected requirements.

Estimated oral duration: 60 seconds
...
Objective: Show functional and non-functional scope without a dense table.
...
Visual suggestion: Three actor lanes plus a thin non-functional requirement rail.

Transition: These requirements are supported by the technical architecture.

Estimated oral duration: 55 seconds
...
Objective: Explain architecture in a simplified oral diagram.
...
Visual suggestion: Four-layer architecture: Angular, Spring Boot, FastAPI/Ollama, PostgreSQL + local PDF storage.

Transition: I will now show how this architecture was implemented progressively through Scrum.

Estimated oral duration: 70 seconds
...
Objective: Present the first Scrum increment and its concrete value.
...
Visual suggestion: Sprint 1 timeline with three proof screenshots: login, upload, user management.
...
Objective: Show how submission becomes exploitable data.
...
Visual suggestion: Data pipeline from PDF to editable metadata to vector storage, with metadata form screenshot.

Transition: Once papers are indexed, Sprint 3 can support assignment and review assistance.

Estimated oral duration: 65 seconds
...
Objective: Show final workflow features and human validation.
...
Visual suggestion: Review loop: suggestions -> assignment -> reviewer toolkit -> review submission -> final decision.
...
Objective: Prepare the jury for the demo scenario.
...
Visual suggestion: Numbered demo storyboard with five screens and expected role changes.
...
Objective: Show mature understanding of limitations and future work.
...
Visual suggestion: Future roadmap split into AI quality, governance, deployment, analytics.

Transition: I will now conclude by summarizing the value delivered by the project.

Estimated oral duration: 50 seconds
...
Objective: Close professionally and open the discussion.
...
Visual suggestion: Clean closing slide with the full workflow reduced to one thin line and a Q&A marker.
...
## Likely Jury Questions and Suggested Answers
